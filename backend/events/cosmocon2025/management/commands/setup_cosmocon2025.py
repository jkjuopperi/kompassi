...
class Setup:
    ...
    def setup_labour(self):
        ...
        labour_event_meta_defaults = dict(
            ...
            contact_email="Cosmoconin työvoimavastaava <info@cosmocon.fi>",
        )
    ...
    def setup_tickets(self):
        ...
        for product_info in [
            ...
            dict(
                name="Iltabilelippu",
                description="Iltabilelippu oikeuttaa sisäänpääsyyn Cosmoconin iltabileisiin tapahtuman lauantai-iltana.",
                limit_groups=[
